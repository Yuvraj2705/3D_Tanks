...
public class FirstPerson : MonoBehaviour
{
    ...
    [SerializeField, Range(1, 180)] private float upperLookLimit = 2.0f;
    [SerializeField, Range(1, 180)] private float lowerLookLimit = 2.0f;
